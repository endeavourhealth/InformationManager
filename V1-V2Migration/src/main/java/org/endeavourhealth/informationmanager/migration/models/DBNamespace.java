...
public class DBNamespace {
    ...
    public static DBNamespace CORE = new DBNamespace(4, ":", "http://www.DiscoveryDataService.org/InformationModel/Ontology#");
    ...
    public static DBNamespace READ2 = new DBNamespace(10, "r2:", "http://www.DiscoveryDataService.org/InformationModel/Legacy/READ2#");
    public static DBNamespace CTV3 = new DBNamespace(11, "ctv3:", "http://www.DiscoveryDataService.org/InformationModel/Legacy/CTV3#");
    public static DBNamespace EMIS = new DBNamespace(12, "emis:", "http://www.DiscoveryDataService.org/InformationModel/Legacy/EMIS#");
    public static DBNamespace TPP = new DBNamespace(14, "tpp:", "http://www.DiscoveryDataService.org/InformationModel/Legacy/TPP#");
    public static DBNamespace BARTS = new DBNamespace(15, "bc:", "http://www.DiscoveryDataService.org/InformationModel/Legacy/Barts_Cerner#");
