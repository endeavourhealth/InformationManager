...
CREATE TABLE IF NOT EXISTS ontology (
  ...
  PRIMARY KEY (`dbid`),
  UNIQUE INDEX `ontology_iri_uq` (`iri` ASC)
) ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS document (
  ...
  `updated` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`dbid`),
  UNIQUE INDEX `document_uuid_uq` (`uuid` ASC),
  INDEX `document_module_idx` (`module` ASC),
  INDEX `document_ontology_idx` (`ontology` ASC),
...
CREATE TABLE IF NOT EXISTS `module` (
  ...
  `updated` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`dbid`),
  UNIQUE INDEX `module_iri_uq` (`iri` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `namespace` (
  ...
  `updated` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`dbid`),
  UNIQUE INDEX `namespace_iri_uq` (`iri` ASC) ,
  UNIQUE INDEX `namespace_prefix_uq` (`prefix` ASC) )
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `axiom` (
  ...
  PRIMARY KEY (`dbid`),
  INDEX `axiom_concept_fk` (`concept` ASC) ,
  INDEX `axiom_module_fk` (`module` ASC) ,
...
CREATE TABLE IF NOT EXISTS `concept_tct` (
  ...
  `target` INT NOT NULL,
  PRIMARY KEY (`dbid`),
  INDEX `concept_tct_source_property_idx` (`source` ASC) ,
  INDEX `concept_tct_property_target_idx` (`target` ASC) )
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
-- ------------------------------
...
CREATE TABLE IF NOT EXISTS `classification` (
  ...
  PRIMARY KEY (`dbid`),
  INDEX `classification_parent_idx` (`parent` ASC) ,
  INDEX `classification_child_idx` (`child` ASC) ,
  INDEX `classification_module_idx` (`module` ASC) )
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `expression` (
  ...
  INDEX `expression_target_concept_fk` (`target_concept`) ,
...
CREATE TABLE IF NOT EXISTS `property_value` (
  ...
  PRIMARY KEY (`dbid`),
  INDEX `property_value_expression_idx` (`expression` ASC) ,
  INDEX `property_value_property_ids` (`property` ASC) ,
  INDEX `property_value_value_expression` (`value_expression` ASC) ,
...
CREATE TABLE IF NOT EXISTS `datatype_definition` (
  ...
  PRIMARY KEY (`dbid`),
  INDEX `dt_concept_idx` (`concept` ASC) ,
  CONSTRAINT `dt_concept`
    FOREIGN KEY (`concept`)
    REFERENCES `concept` (`dbid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    INDEX `dt_module_idx` (`module` ASC) ,
...
CREATE TABLE IF NOT EXISTS `valueset_tct` (
  ...
  `target` INT NOT NULL,
  PRIMARY KEY (`dbid`),
  INDEX `concept_tct_source_property_idx` (`source` ASC, `property` ASC) ,
  INDEX `concept_tct_property_level_idx` (`property` ASC, `level` ASC) ,
  INDEX `concept_tct_property_target_idx` (`property` ASC, `target` ASC) )
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
;
...
CREATE TABLE IF NOT EXISTS `concept_annotation` (
  ...
  PRIMARY KEY (`dbid`),
  INDEX `concept_annotation_concept_fk` (`concept` ASC) ,
  INDEX `concept_annotation_value_type_fk` (`value_type` ASC) ,
   INDEX `concept_annotation_property_fk` (`property` ASC) ,
