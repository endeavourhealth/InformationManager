...
DROP TABLE IF EXISTS concept_origin;
CREATE TABLE concept_origin (
    id TINYINT NOT NULL,
    name VARCHAR(20) NOT NULL,

    PRIMARY KEY concept_origin_pk (id)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;

INSERT INTO concept_origin
(id, name)
VALUES
(0, 'Core'),
(1, 'Legacy');
...
(
    ...
    origin      TINYINT NOT NULL DEFAULT 0,
...
CREATE TABLE concept_property_object (
    ...
    INDEX concept_property_object_concept_idx (concept),    -- Include property?
    INDEX concept_property_object_object_idx (object)       -- Include property?
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
...
CREATE TABLE concept_property_data (
    ...
    INDEX concept_property_object_data_idx (concept)        -- Include property?
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
