...
import 'd3';
import 'nvd3';
import { DraftConceptEditor } from './draft-concept-editor.component';
...
describe('DraftConceptEditor', () => {
  let component: DraftConceptEditor;
  let fixture: ComponentFixture<DraftConceptEditor>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ DraftConceptEditor ],
      providers: [
        LoggerService,
        ModuleStateService,
        ConceptService,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DraftConceptEditor);
